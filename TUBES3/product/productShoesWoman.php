    ...
    <div class="container">
      <div class="row gy-2">
        ...
        <div class="order-lg-last col-lg-5 col-sm-8 col-8" >
          <form method="GET" action="productShoesWoman.php">
    ...
    <div class="row flex justify-content-center">
      ...
      <div class="col-lg-9">
        <header class="d-sm-flex align-items-center border-bottom mb-4 pb-3">
          ...
          <?php
            if(isset($_GET['keyword'])){
              ...
              $total_result = mysqli_query($con,"SELECT * FROM product WHERE jenis = 'Shoe' AND nama LIKE '%".$keyword."%' AND sex = 'F'");
              $row = mysqli_num_rows($total_result);
              echo "Total Item: " . $row;
              
            }else {
              $total_result = mysqli_query($con,"SELECT * FROM product WHERE jenis = 'Shoe' AND sex = 'F'");
              $row = mysqli_num_rows($total_result);
                echo "Total Item: " . $row;
            }
          ?>
        ...
        <?php 
          if(isset($_GET['keyword'])){
            $keyword = $_GET['keyword'];
            $search_result = mysqli_query($con,"SELECT * FROM product WHERE jenis = 'Shoe' AND nama LIKE '%".$keyword."%' AND sex = 'F' limit $start_from,$num_per_page");
          }else{
            $search_result = mysqli_query($con,"SELECT * FROM product WHERE jenis = 'Shoe' AND sex = 'F' limit $start_from,$num_per_page");
          }
        ...
        $total_page = ceil($total_record/$num_per_page);
          ...
          if($page>1)
          {
              echo "<a href='productShoesWoman.php?page=".($page-1)."'  class='btn btn-danger'>Previous</a>";
          }

          for($i=1;$i<$total_page;$i++)
          {
              echo "<a href='productShoesWoman.php?page=".$i."' class='btn btn-primary'>$i</a>";
          }

          if($page < $total_page)
          {
              echo "<a href='productShoesWoman.php?page=".($page+1)."' class='btn btn-danger'>Next</a>";
          }
